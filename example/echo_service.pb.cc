...
const char descriptor_table_protodef_echo_5fservice_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "2s\n\016EchoServiceRpc\0221\n\004Echo\022\023.fixbug.Echo"
  "Request\032\024.fixbug.EchoResponse\022.\n\003Add\022\022.f"
  "ixbug.AddRequest\032\023.fixbug.AddResponseB\003\200"
  "\001\001b\006proto3"
  ;
...
const ::_pbi::DescriptorTable descriptor_table_echo_5fservice_2eproto = {
    false, false, 290, descriptor_table_protodef_echo_5fservice_2eproto,
    "echo_service.proto",
...
void EchoServiceRpc::Add(::PROTOBUF_NAMESPACE_ID::RpcController* controller,
...
void EchoServiceRpc_Stub::Add(::PROTOBUF_NAMESPACE_ID::RpcController* controller,
